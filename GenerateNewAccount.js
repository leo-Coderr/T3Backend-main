...
const generateNewWallet = async (addressIndex = 0) => {
  try {
    const seedPhrase = bip39.generateMnemonic();
    return await generateWalletFromSeed(seedPhrase, addressIndex);
  } catch (error) {
...
module.exports = { generateWalletFromSeed, generateNewWallet };
